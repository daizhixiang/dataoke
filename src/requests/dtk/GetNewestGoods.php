...
class GetNewestGoods extends DtkRequest
{
    ...
    public $extraParasField = [
        ...
        "商品上架开始时间" => "startTime",//	否	Date	请求格式：yyyy-MM-dd HH:mm:ss
        "商品上架结束时间" => "endTime",//	否	Date	请求格式：yyyy-MM-dd HH:mm:ss
        "一级类目Id" => "cids",//	否	String	大淘客的一级分类id，如果需要传多个，以英文逗号相隔，如：”1,2,3”。当一级类目id和二级类目id同时传入时，会自动忽略二级类目id，1 -女装，2 -母婴，3 -美妆，4 -居家日用，5 -鞋品，6 -美食，7 -文娱车品，8 -数码家电，9 -男装，10 -内衣，11 -箱包，12 -配饰，13 -户外运动，14 -家装家纺
